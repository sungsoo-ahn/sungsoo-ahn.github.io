...
4. Run `python3 scripts/validate_blog.py` to catch missing or unused blog assets
5. Expect multiple rounds of refinement per figure
6. All data should be hardcoded (approximate/illustrative values, not copyrighted)

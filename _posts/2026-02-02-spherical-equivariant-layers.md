...
[^physics-sh]: From a physics standpoint, spherical harmonics are the eigenstates of the angular momentum operators, so their transformation behavior under rotation is also rigorously defined in this viewpoint.

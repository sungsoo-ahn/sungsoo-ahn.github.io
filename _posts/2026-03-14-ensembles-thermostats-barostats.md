...
- Ensemble diagrams (`ens_system_boundary.svg`, `ens_four_ensembles.svg`): custom explanatory figures generated by `scripts/generate_ensemble_figures.py` with SVG+PNG outputs and the shared blog figure style.
